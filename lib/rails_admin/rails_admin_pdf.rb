          ...
          Proc.new do
            ...
            Prawn::Document.new(PDF_OPTIONS) do |pdf|
              ...
              if @object.sales.count > 0
                ...
                g.write("public/#{random_file_name}_graph.jpg")
                ...
                pdf.image "public/#{random_file_name}_graph.jpg", :scale => 0.50
              end
            ...
            File.delete("public/#{random_file_name}_graph.jpg") if @object.sales.count > 0
          end
        end
